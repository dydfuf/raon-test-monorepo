...
import { Button, buttonVariants } from "@raonc/ui/components/button";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
import { Alert, AlertDescription, AlertTitle } from "@raonc/ui/components/alert";
import {
  BarChartIcon,
  CalendarIcon,
  CaretSortIcon,
...
import { toast } from "@raonc/ui/components/sonner";
...
export default function page() {
  ...
  return (
    <div className="p-20 flex flex-col gap-10">
      ...
      <Preview title="Calendar" className="mx-auto">
        <Calendar
          mode="single"
          selected={date}
          onSelect={setDate}
      ...
      <Preview title="Carousel" className="mx-auto">
      ...
      <Preview title="Context Menu" className="mx-auto">
        <ContextMenu>
      ...
      <Preview title="Date Picker" className="mx-auto">
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant={"outline"}
      ...
      <Preview title="Dialog" className="mx-auto">
        <Dialog>
      ...
      <Preview title="Drawer" className="mx-auto">
        <Drawer>
      ...
      <Preview title="Dropdown Menu" className="mx-auto">
        <DropdownMenu>
      ...
      <Preview title="Menubar" className="mx-auto">
        <Menubar>
          <MenubarMenu>
      ...
      <Preview title="Navigation Menu" className="mx-auto">
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
      ...
      <Preview title="Popover" className="mx-auto">
        <Popover>
          <PopoverTrigger asChild>
      ...
      <Preview title="Sheet" className="mx-auto">
        <Sheet>
